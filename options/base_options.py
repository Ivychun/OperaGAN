...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='Xiqu-Dataset/images', help='path to images')
        ...
        self.parser.add_argument('--dirmap', type=str, default='Xiqu-Dataset/segs', help='path to parsing maps)')
