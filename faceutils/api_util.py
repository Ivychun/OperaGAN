...
class FacePPAPI():
    def __init__(self):
        ...
        self.left_eye_inner1 = self.left_eye_inner + ['left_eye_top', 'left_eye_upper_right_quarter', 'left_eye_right_corner', 'left_eye_lower_right_quarter']

        self.left_eyebrow = [l for l in self.landmark_all if l.startswith("left_eyebrow_")]
        self.left_eye = self.left_eyebrow + self.left_eye_inner1
        ...
        self.right_eye_inner1 = self.right_eye_inner +  ['right_eye_top', 'right_eye_upper_right_quarter', 'right_eye_right_corner', 'right_eye_lower_right_quarter']

        self.right_eyebrow = [l for l in self.landmark_all if l.startswith("right_eyebrow_")]
        self.right_eye = self.right_eyebrow + self.right_eye_inner1
